...
# fc10<-fread("/afcars/afcarsfc2010.csv", data.table=FALSE)
# fc09<-fread("/afcars/afcarsfc2009.csv", data.table=FALSE)
# fc08<-fread("/afcars/afcarsfc2008.csv", data.table=FALSE)
# fc07<-fread("/afcars/afcarsfc2007.csv", data.table=FALSE)
# fc06<-fread("/afcars/afcarsfc2006.csv", data.table=FALSE)
# fc05<-fread("/afcars/afcarsfc2005.csv", data.table=FALSE)
# fc04<-fread("/afcars/afcarsfc2004.csv", data.table=FALSE)
# fc03<-fread("/afcars/afcarsfc2003.csv", data.table=FALSE)
# fc02<-fread("/afcars/afcarsfc2002.csv", data.table=FALSE)
