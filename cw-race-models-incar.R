...
descriptives<-xtable(cbind(means, sds, mins, maxs), caption="Descriptive Statistics")
...
row.names(b.c.tab)<- c("Intercept", "Black/White Incarceration rate", "Black/White Unemployment rate", "Black/White Single parent rate", 
                       "Black/White Adults w/o HS rate", "Black/White Child poverty rate", "Percent Black/White population",
                       "Leg. Ideology", "Violent crime rate", "Year")
print(xtable(b.c.tab, caption="Black/White foster care caseload disproportion. Multilevel linear regression", label="b.d.tab", digits=3), 
      type="latex", file="b_d_tab.tex")

a.d.tab<-makeMIRegTab(a.disp)
row.names(b.c.tab)<- c("Intercept", "Native Am./White Incarceration rate", "Native Am./White Unemployment rate", "Native Am./White Single parent rate", 
                       "Native Am./White Adults w/o HS rate", "Native Am./White Child poverty rate", "Percent Native Am./White population",
                       "Leg. Ideology", "Violent crime rate", "Year")
print(xtable(b.c.tab, caption="Native American/White foster care caseload disproportion. Multilevel linear regression", label="a.d.tab", digits=3), 
      type="latex", file="a_d_tab.tex")

l.d.tab<-makeMIRegTab(l.disp)
row.names(b.c.tab)<- c("Intercept", "Latino/White Incarceration rate", "Black Unemployment rate", "Black Single parent rate", 
                       "Black Adults w/o HS rate", "Black Child poverty rate", "Percent Black population",
                       "Leg. Ideology", "Violent crime rate", "Year")
print(xtable(b.c.tab, caption="Latino/White foster care caseload disproportion. Multilevel linear regression", label="l.c.tab", digits=3), 
