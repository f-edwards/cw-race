...
colClasses=sapply(fread("usa_00042.csv", nrows=100), class)
dat3<-as.data.frame(fread("usa_00042.csv", colClasses=colClasses))
dat3<-dat3%>%filter(!((YEAR==2010)&(DATANUM==1))) ## DROP 2010 census, to be used for MI prior
...
write.csv(dat4, "pop-race-2000-2014.csv", row.names=FALSE)