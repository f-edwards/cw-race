...
row.names(b.c.tab)<- c( "Black incarceration rate", "Black unemployment rate", "Black single parent rate",
...
row.names(a.c.tab)<- c( "Native Am. incarceration rate", "Native Am. unemployment rate", "Native Am. single parent rate",
...
row.names(l.c.tab)<- c( "Latino Incarceration rate", "Latino Unemployment rate", "Latino Single parent rate",
...
row.names(b.d.tab)<- c( "Black/White Incarceration rate", "Black/White Unemployment rate", "Black/White Single parent rate",
...
row.names(a.d.tab)<- c( "Native Am./White Incarceration rate", "Native Am./White Unemployment rate", "Native Am./White Single parent rate",
...
row.names(l.d.tab)<- c( "Latino/White incarceration rate", "Latino/White unemployment rate", "Latino/White single parent rate",
