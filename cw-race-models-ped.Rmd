...
fc.ineq<-fc.ineq%>%
  select(cl.blk, b.incarrt, chpov.blk.pc, chpovrt,
         ...
         w.welf.incl, a.snap.incl, b.snap.incl, l.snap.incl, w.snap.incl)%>%
  filter(stname!="HI")

bounds<-cbind(1:ncol(fc.ineq),
              rep(0.01, ncol(fc.ineq)),
...
b.ineq.glmer<-glmer(cl.blk~-1+scale(b.incarrt)+
        scale(b.welf.incl)+scale(b.snap.incl)+
...
l.ineq.glmer<-glmer(cl.latino~-1+scale(l.incarrt)+
        scale(l.welf.incl)+scale(l.snap.incl)+        
...
a.ineq.glmer<-glmer(cl.nat.am~-1+scale(a.incarrt)+
        ...
        scale(a.welf.incl)+scale(a.snap.incl)+
        scale(chpovrt)+scale(incarrt)+
        scale(inst6014_nom)+
        year.c+
